    ...
    <section id="projects" className="py-32 bg-background">
      <div className="max-w-340 mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-end mb-20">
          ...
          <p className="text-foreground/70 mb-2">(Feb 2025 - Present)</p>
        </div>
          ...
          {PROJECTS.map((project) => (
            ...
            >
              <div>
                ...
                <div className="flex flex-col md:flex-row justify-between items-start border-t border-foreground/20 pt-6">
                  <div>
                  ...
                  <div className="flex gap-2 mt-4 flex-wrap md:mt-0">
                    {project.technologies.map((tech) => (
                      <span
                        key={tech}
                        className="px-4 py-1 border border-foreground/20 rounded-full text-xs uppercase tracking-wider text-foreground/70"
                      >
                        {tech}
                      </span>
                    ))}
